...
void KHangManView::slotTry()
{
	...
	if (containsChar(guess)) {
		...
		else if (KMessageBox::questionYesNo(this, i18n("Congratulations! You won! Do you want to play again?"),QString(),i18n("Play Again"), i18n("Do Not Play")) == 3)
		    slotNewGame();
		else
		    kapp->quit();
	    }
		...
		else if (KMessageBox::questionYesNo(this, newGameString, QString(), i18n("Play Again"), i18n("Do Not Play")) == 3)
		    slotNewGame();
		else
		    kapp->quit();
	    }
